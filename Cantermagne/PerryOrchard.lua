...
local p = game:GetService('Players').LocalPlayer
        ...
        local pos1 = Vector3.new(-1539.7076416015625, 177.39999389648438, 1441.055908203125)
        local pos2 = Vector3.new(-689.682373046875, 113.59449005126953, -289.57666015625)
