-- Fort Belle Prison Camp Teleport
local p = game:GetService('Players').LocalPlayer
        ...
        local pos1 = Vector3.new(1956.1871337890625, 51.06794738769531, -1598.0697021484375)
        local pos2 = Vector3.new(1393.7362060546875, 55.96315002441406, -2609.96044921875)
