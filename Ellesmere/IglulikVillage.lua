...
local p = game:GetService('Players').LocalPlayer
        ...
        local pos1 = Vector3.new(-1231.9552001953125, 149.59999084472656, 31.056079864501953)
        local pos2 = Vector3.new(487.31201171875, 289.335693359375, -2173.094970703125)
